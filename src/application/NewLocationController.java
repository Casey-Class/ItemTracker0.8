...
public class NewLocationController {
	...
	@FXML TextField locationDescription; // Text field for entering location description
	/**
	...
	public void addLocation() {
		...
		if (locationCategoryName.isEmpty()) {
			...
			saveLocationCategoryToCSV(locationCategoryName, description); //Saves the location to CSV file
			locationNameLabel.setText(""); // Clears the text field once the locationName is saved.
			locationDescription.setText(""); // Clears the text field once the locationDescription is saved.
		}
	 ...
	 */
	public void saveLocationCategoryToCSV(String locationCategoryName, String description) {
		Location location;
		
		if(description == null)
		{
			location = new Location(locationCategoryName);
		}
		else
		{
			location = new Location(locationCategoryName, description);
		}
	    ...
	    try {
	        ...
	        try (FileWriter fw = new FileWriter(filePath, true);
	            ...
	            out.println(location.toString()); // Write the location category name to the file.
	        } catch (IOException e) {
